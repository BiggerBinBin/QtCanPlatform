...
#define KVLC_PROPERTY_FULLY_QUALIFIED_NAMES         30    ///< (int) Write fully qualified names.
 ...
 *
 * int use_offset = 1;
 * kvlcSetProperty(hnd, KVLC_PROPERTY_USE_OFFSET, &use_offset, sizeof(use_offset));
 *
 * \param[in]   handle       An open handle to a converter.
 * \param[in]   property     Property, use \ref PROPERTY_xxx.
 ...
 *
 * char sep;
 * kvlcGetProperty(hnd, KVLC_PROPERTY_SEPARATOR_CHAR, &sep, sizeof(sep));
 *
 * \param[in]   handle       An open handle to a converter.
 * \param[in]   property     Property, use \ref PROPERTY_xxx.
 * \param[out]  buf          Buffer to receive property value.
 ...
 *
 * \source_cs
 * <b>static Kvlclib.Status GetReaderPropertyDefaultInt(FileFormat format, Property property, out Int32 value);</b><br>
 * <b>static Kvlclib.Status GetReaderPropertyDefaultUInt32(FileFormat format, Property property, out UInt32 value);</b><br>
 * <b>static Kvlclib.Status GetReaderPropertyDefaultChar(FileFormat format, Property property, out Char value);</b><br>
 * <b>static Kvlclib.Status GetReaderPropertyDefaultTime64(FileFormat format, Property property, out Int64 value);</b>
 * \source_end
 *
 * Get the default value for a property. The buffer pointer and length of the
 * data type must match the property specified in \ref PROPERTY_xxx, e.g.
