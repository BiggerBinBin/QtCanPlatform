...
CString CFrameDefinition::getId() 
{	
	CString result;
	result.Format(_T("%02Xh"), m_nID); 
	return result; 
}
...
CString CFrameDefinition::getProtectedId() 
{	
	CString result;
	result.Format(_T("%02Xh"), m_nProtectedID); 
	return result; 
}
...
CString CFrameDefinition::getLengthAsString()	
{ 
	CString result;
	result.Format(_T("%d"), m_nLength); 
	return result; 
}
